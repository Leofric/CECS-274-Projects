/**
 * This Class simulates a digital phonebook that is used to store contacts. This class stores contact objects created
 * by the contact class. This class can add contacts, edit contacts, find and display details about a particular contact
 * or display all contacts currently stored.
 * 
...
public class PhoneBook {
	...
	/**
	 * This method searches the phonebook for a contact, if found, returns true.
	...
	/**
	 * This method returns the string variable that stores the last contact
	 * printed
	 * 
	 * @return returns the name of the contact, type string
	 */
